...
This directory contains sanitized, implementation-facing specifications and
independently authored fixtures. It must not contain copied upstream source,
tests, SQL, documentation prose, or implementation plans.
